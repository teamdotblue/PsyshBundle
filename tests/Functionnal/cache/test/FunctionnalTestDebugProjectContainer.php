...
/**
 * FunctionnalTestDebugProjectContainer.
 *
 * This class has been auto-generated
 * by the Symfony Dependency Injection Component.
 */
class FunctionnalTestDebugProjectContainer extends Container
{
    private $parameters;
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'psysh.shell' => 'getPsysh_ShellService',
        ...
        $this->aliases = array(
            'console.command.fidry_psyshbundle_command_psyshcommand' => 'psysh.command.shell_command',
    ...
    {
        return $this->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(array(0 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TranslationsCacheWarmer($this->get('translator')), 1 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\RouterCacheWarmer($this->get('router'))));
    }
    ...
    /**
     * Gets the 'psysh.command.shell_command' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     *
     * @return \Fidry\PsyshBundle\Command\PsyshCommand A Fidry\PsyshBundle\Command\PsyshCommand instance.
     */
    protected function getPsysh_Command_ShellCommandService($lazyLoad = true)
    {
        return $this->services['psysh.command.shell_command'] = new \Fidry\PsyshBundle\Command\PsyshCommand($this->get('psysh.shell'));
    }

    /**
     * Gets the 'psysh.shell' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Psy\Shell A Psy\Shell instance.
     */
    protected function getPsysh_ShellService()
    {
        $this->services['psysh.shell'] = $instance = new \Psy\Shell();

        $instance->setScopeVariables(array('container' => $this, 'kernel' => $this->get('kernel'), 'parameters' => $this->get("service_container")->getParameterBag()->all()));
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, NULL, array('cache_dir' => __DIR__, 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'FunctionnalTestUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'FunctionnalTestUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), NULL);
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('PsyshBundleSecret');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.container_class' => 'FunctionnalTestDebugProjectContainer',
            ...
            'kernel.secret' => 'PsyshBundleSecret',
            ...
            'router.options.matcher.cache_class' => 'FunctionnalTestUrlMatcher',
            'router.options.generator.cache_class' => 'FunctionnalTestUrlGenerator',
            'router_listener.class' => 'Symfony\\Component\\HttpKernel\\EventListener\\RouterListener',
            'router.request_context.host' => 'localhost',
            'router.request_context.scheme' => 'http',
            'router.request_context.base_url' => '',
            'router.resource' => NULL,
            'router.cache_class_prefix' => 'FunctionnalTest',
            ...
            'debug.container.dump' => (__DIR__.'/FunctionnalTestDebugProjectContainer.xml'),
            'debug.controller_resolver.class' => 'Symfony\\Component\\HttpKernel\\Controller\\TraceableControllerResolver',
            'console.command.ids' => array(
                0 => 'psysh.command.shell_command',
            ),
        );
    }
}
